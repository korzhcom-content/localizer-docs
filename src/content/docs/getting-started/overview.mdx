...
- you don't need to use Delphi to translate application interface. It allows to separate application development from a translation process;
- you can process the resource string section in your project units and, therefore, translate Delphi packages and DLLs, VCL and third-party components messages.   
